...
- `infographic.html` - older full-length infographic source restored from repo history
- `index.html` - older browser-friendly long guide restored from repo history
- `utopia-of-the-seas-infographic.jpg` and `infographic-jpg/utopia-of-the-seas-infographic.jpg` - tall infographic exports from the earlier package

## What is covered

- exact itinerary for the June 29 to July 3 sailing
- restored 10-page infographic content
- maximized daily schedules
